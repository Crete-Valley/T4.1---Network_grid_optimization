(function () {
    ...
    ***************************************************************************** */
    ...
    var handle_err = function (json) {
        if (json && "detail" in json) {
            throw json.detail.split('\n').filter(function (s) { return s.trim().length !== 0; }).slice(-1)[0];
        }
        return json;
    };
    function mkapi() {
        ...
        return {
            ...
            get_results: function () { return __awaiter(_this, void 0, void 0, function () {
                var res, json;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fetch("/ts/result")];
                        case 1:
                            res = _a.sent();
                            return [4 /*yield*/, res.json()];
                        case 2:
            ...
            get_result: function (fname) { return __awaiter(_this, void 0, void 0, function () {
                var res, json;
                return __generator(this, function (_a) {
                    switch (_a.label) {
            ...
            runsim: function (params) { return __awaiter(_this, void 0, void 0, function () {
                var res, json;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, fetch("/s", {
                                method: "POST",
            ...
            simform.onsubmit = function (ev) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.trys.push([1, 3, , 4]);
                            return [4 /*yield*/, api.runsim(params_1)];
                        case 2:
                            _a.sent();
